    ...
    <div className="max-w-md mx-auto my-16 animate-fade-in relative z-10">
      <div className="bg-white/80 dark:bg-slate-900/75 backdrop-blur-md border border-slate-200/50 dark:border-slate-800/60 shadow-2xl rounded-2xl p-8 space-y-6">
        ...
        {viewMode === 'forgot_email' && (
          <>
            <div className="text-center space-y-1.5">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">Enter your email to receive a 6-digit OTP code.</p>
            </div>
            ...
            <form onSubmit={handleForgotPasswordSubmit} className="space-y-4">
              ...
              <button
                ...
                className="w-full text-center text-xs text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 font-semibold flex items-center justify-center gap-1.5 mt-2"
                disabled={loading}
              >
        ...
        {viewMode === 'forgot_reset' && (
          <>
            <div className="text-center space-y-1.5">
              <h1 className="font-display font-bold text-2xl text-slate-800 dark:text-white">Reset Password</h1>
              <p className="text-xs text-slate-500 dark:text-slate-400">Enter the OTP sent to <strong>{forgotEmail}</strong> and your new password.</p>
            </div>
