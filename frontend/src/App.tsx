...
const mapMarketplaceItemToAsset = (item: MarketplaceItemResponse, t: TranslateFn): Asset => {
  ...
  return {
    ...
    rating: item.averageRating !== undefined && item.averageRating !== null ? item.averageRating : 0.0,
    reviewedCount: item.reviewCount || 0,
...
export default function App() {
  ...
  const mapGameToAsset = (game: any): Asset => ({
    ...
    rating: game.averageRating !== undefined && game.averageRating !== null ? game.averageRating : 0.0,
    reviewedCount: game.reviewCount || 0,
