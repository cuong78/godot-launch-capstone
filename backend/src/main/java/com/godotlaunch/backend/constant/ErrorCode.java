...
public enum ErrorCode {
    ...
    FACE_CHALLENGE_INVALID(HttpStatus.BAD_REQUEST, "Challenge khuôn mặt không hợp lệ hoặc đã được sử dụng."),
    FACE_CHALLENGE_EXPIRED(HttpStatus.BAD_REQUEST, "Challenge khuôn mặt đã hết hạn. Vui lòng bắt đầu lại."),
    FACE_LIVENESS_FAILED(HttpStatus.UNPROCESSABLE_ENTITY, "Không thể xác nhận chuyển động khuôn mặt. Vui lòng thử lại."),
    FACE_SERVICE_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE, "Dịch vụ AI khuôn mặt đang tạm thời không khả dụng."),
