    ...
    return (
        <aside className="col-span-1 md:col-span-3 flex flex-col gap-8">
            <div className="bg-surface-container/30 backdrop-blur-md rounded-xl border border-white/5 p-6">
                <h3 className="font-headline-md text-headline-md text-on-surface mb-4 text-[18px]"> {t('topCreators')} </h3>
                <ul className="flex flex-col gap-4">
                    <li className="flex items-center gap-3">
                        ...
                        <span className="font-body-md text-body-md text-on-surface flex-grow"> {t('studioNomad')} </span>
                    ...
                    <li className="flex items-center gap-3">
                        ...
                        <span className="font-body-md text-body-md text-on-surface flex-grow"> {t('pixelForge')} </span>
                    </li>
                </ul>
            </div>

            <div className="bg-surface-container/30 backdrop-blur-md rounded-xl border border-white/5 p-6">
                <h3 className="font-headline-md text-headline-md text-on-surface mb-4 text-[18px]"> {t('communityContent')} </h3>
            ...
            <div className="bg-surface-container/30 backdrop-blur-md rounded-xl border border-white/5 p-6">
                <h3 className="font-headline-md text-headline-md text-on-surface mb-4 text-[18px]"> {t('friendsList')} </h3>
                <ul className="flex flex-col gap-3">
                    ...
                    <li className="flex items-center gap-3 cursor-pointer group">
                        <div className="relative">
                            ...
                            <span className="absolute bottom-0 right-0 w-2.5 h-2.5 bg-on-surface-variant rounded-full border-2 border-surface-container"> </span>
                        </div>
