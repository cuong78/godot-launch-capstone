        ...
        <section className="col-span-1 md:col-span-6 flex flex-col gap-8">
            <div className="bg-surface-container/60 backdrop-blur-xl rounded-xl border border-white/10 p-4 shadow-[0_0_20px_rgba(0,0,0,0.5)]">
                <div className="flex items-center gap-4 border-b border-surface-variant pb-4">
                    ...
                    <input className="w-full bg-transparent border-none outline-none text-on-surface font-body-md text-body-md focus:ring-0 placeholder:text-on-surface-variant" placeholder="Share concept art, thoughts, or game updates..." type="text" />
                </div>
                <div className="flex justify-between items-center pt-4">
                    ...
                    <button className="bg-surface-tint text-background px-6 py-2 rounded-lg font-label-sm text-label-sm font-bold uppercase tracking-widest hover:bg-primary-fixed-dim transition-colors">Post</button>
                </div>
            </div>
            ...
            <article className="bg-surface-container/40 backdrop-blur-lg rounded-xl border border-white/5 p-6 hover:border-secondary/50 transition-colors duration-300">
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <span className="font-headline-md text-headline-md text-on-surface text-[16px] block">Dev_Sarah</span>
                ...
                <p className="font-body-md text-body-md text-on-surface mb-4">
                    Early environment explorations for the undercity level. Trying to capture that oppressive yet vibrant neon-noir feel. Thoughts on the color palette?
                </p>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                    <span className="bg-surface-dim border border-surface-variant text-on-surface font-label-sm text-label-sm px-3 py-1 rounded">RPG</span>
                    <span className="bg-surface-dim border border-surface-variant text-on-surface font-label-sm text-label-sm px-3 py-1 rounded">Multiplayer</span>
                    <span className="bg-surface-dim border border-surface-variant text-on-surface font-label-sm text-label-sm px-3 py-1 rounded">Stealth</span>
                    <span className="bg-surface-dim border border-surface-variant text-on-surface font-label-sm text-label-sm px-3 py-1 rounded">Puzzle</span>
                </div>
                <div className="flex items-center gap-6 border-t border-surface-variant pt-4">
