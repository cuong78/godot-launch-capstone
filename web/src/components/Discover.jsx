  ...
  return (
    <section>
      <div className="flex items-center gap-4 mb-8 border-b border-white/5 pb-4">
        <h2 className="font-headline-lg text-headline-md text-white">DISCOVER</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter auto-rows-[280px]">
        ...
        <Link to="/product/neon-drifter" className="md:col-span-8 row-span-2 group relative rounded-xl overflow-hidden glass-panel border border-white/10 hover:border-surface-tint transition-colors duration-500 hover:shadow-[0_0_25px_rgba(0,242,255,0.2)] block cursor-pointer">
          ...
          <div className="absolute bottom-0 left-0 w-full p-6">
            <div className="flex gap-2 mb-2">
              <span className="font-label-sm text-label-sm text-on-surface-variant bg-surface/80 px-2 py-0.5 border border-white/10 rounded">RPG</span>
              <span className="font-label-sm text-label-sm text-on-surface-variant bg-surface/80 px-2 py-0.5 border border-white/10 rounded">MULTIPLAYER</span>
            </div>
            <h3 className="font-headline-md text-headline-lg-mobile text-white mb-2">Cyber Bloom</h3>
            <p className="font-body-md text-body-md text-on-surface-variant max-w-md hidden md:block">Restore the digital ecosystem in this co-op action RPG. Hack corrupted nodes and cultivate neon flora.</p>
          </div>
        </Link>
        ...
        <Link to="/product/student-quest" className="md:col-span-4 row-span-1 group relative rounded-xl overflow-hidden glass-panel border border-white/10 hover:border-secondary transition-colors duration-500 hover:shadow-[0_0_20px_rgba(209,188,255,0.2)] bg-surface-container-low block cursor-pointer">
          ...
          <div className="absolute bottom-0 left-0 w-full p-4">
            <h3 className="font-headline-md text-headline-md text-white mb-1">Student Quest</h3>
            <div className="flex justify-between items-center">
              <span className="font-body-md text-body-md text-on-surface-variant">Early Access</span>
        ...
        <Link to="/product/void-protocol" className="md:col-span-4 row-span-1 group relative rounded-xl overflow-hidden glass-panel border border-white/10 hover:border-surface-tint transition-colors duration-500 hover:shadow-[0_0_20px_rgba(0,242,255,0.2)] bg-surface-container-low block cursor-pointer">
          ...
          <div className="absolute bottom-0 left-0 w-full p-4">
            <h3 className="font-headline-md text-headline-md text-white mb-1">Void Protocol</h3>
            <div className="flex justify-between items-center">
              <span className="font-body-md text-body-md text-on-surface-variant">Puzzle / Stealth</span>
              <span className="font-label-sm text-label-sm text-surface-tint">FREE</span>
            </div>
          </div>
        </Link>
      </div>
