...
import { ShoppingCart, Bell, Search, SquareTerminal, Settings } from 'lucide-react';
  ...
  return (
    <nav className="bg-surface/80 backdrop-blur-xl border-b border-white/10 shadow-[0_0_15px_rgba(0,242,255,0.15)] docked full-width top-0 z-50 fixed w-full">
      <div className="flex justify-between items-center w-full px-margin-mobile md:px-margin-desktop py-4 max-w-container-max mx-auto">
        <Link to={isAdmin ? "/admin" : "/"} className={`font-display-lg text-headline-md uppercase tracking-widest ${isAdmin ? 'text-primary-fixed-dim drop-shadow-[0_0_8px_rgba(0,219,231,0.5)] font-black' : 'text-surface-tint'}`}>
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-4 text-surface-tint">
            {isAdmin ? (
              <>
                <button className="hover:text-primary-fixed-dim transition-all duration-300 text-on-surface-variant/70">
            ...
            <Link to="/login" className="w-8 h-8 rounded-full bg-surface-container overflow-hidden border border-white/10 block hover:border-surface-tint transition-all cursor-pointer flex-shrink-0">
              <img alt="User profile" className="w-full h-full object-cover" src={isAdmin ? "https://lh3.googleusercontent.com/aida-public/AB6AXuCa1cAURjwqpEFrc2Tu_jVVbf55otNZTIZ2kSxnLml55ukqSwTyS5xRwkw0OUHPx7UcdWjOOjVeenxKDMBnpQzIle6iXJV5B3UmaUzAG1tenx-Cb5XEimErcZSMg42qNoMjE3n1QOn3IOtZ3HEUxeTD4_RO09qARz9QOn6brVk0Z9AgnNJqd4lp1sF9Uskb2-QN7t7nkjEQ_dbzG9bVOtZcfwQ9lWrRRuj1pRmt6yCbE3L59UzqrgGbXeqGfEPLHZGuya3hsCxL0MrU" : "https://lh3.googleusercontent.com/aida-public/AB6AXuCbd2dT12ZtEf7c-mfxRSvXg2Fn5K64gg5sl24X3AEZbXN2TEtuJ-f9FVI9IsIMgSdHtbmj1OY4EPIU47YJ-SLFnn5lQSkmidlsoIpjrqCodm2AC9tU1s7RpJllR68lvcUXuBkngh5ml8HABcGICSnTBzCosIeDlx9BpKN5f8O_NiKTU0z7lS9JDulDJIDbsGMrPZHrU94xoSmGCwJ9JJjxHO5GQuAtq1Gd70ks3iGCg-JDCsC34-owmdY3jaOPqSurwOuvF_ZAWqyV"}/>
            </Link>
          </div>
        </div>
      </div>
